export default function Page() {
  ...
  return (
    <>
      ...
      <h2>Refund Policy</h2>
      <p>
        Due to the nature of our digital services, we do not issue refunds once
        the order is confirmed and the product is sent. Please read the product
        description carefully before making a purchase.
      </p>
      <p>
        If you have any questions about our products or services, please contact
        us before making a purchase. We will be happy to help you make an
        informed decision.
      </p>
      <h2>Contact Us</h2>
      <p>
