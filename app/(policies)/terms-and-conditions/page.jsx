  ...
  return (
    <>
      ...
      <p>
        ...
        conditions. Do not continue to use ROI Monk if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing ROI Monk, you agreed to use
        cookies in agreement with the ROI Monk&apos;s Privacy Policy.
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, ROI Monk and/or its licensors own the
        intellectual property rights for all material on ROI Monk. All
        intellectual property rights are reserved. You may access this from ROI
        Monk for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from ROI Monk</li>
        <li>Sell, rent or sub-license material from ROI Monk</li>
        <li>Reproduce, duplicate or copy material from ROI Monk</li>
        <li>Redistribute content from ROI Monk</li>
      </ul>
      <p>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. ROI
        Monk does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of ROI Monk, its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, ROI Monk shall not be liable for
      ...
      <p>
        ROI Monk reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant ROI Monk a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of ROI Monk; and (d) the link is
      ...
      <p>
        ...
        e-mail to ROI Monk. Please include your name, your organization name,
      ...
      <p>
        No use of ROI Monk&apos;s logo or other artwork will be allowed for
